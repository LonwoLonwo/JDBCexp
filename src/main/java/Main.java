...
public class Main {
    public static void main(String[] args) {
        String url = "jdbc:mysql://localhost:3306/skillbox02"; //можно не указывать в этой строке название БД, а использовать команду use, но обычно в одном приложении
        ...
        String pass = "test"; //not my password
        try {
            Connection connection = DriverManager.getConnection(url, user, pass);//получаем соединение с помощью драйверМенеджера
